                ...
                try:
                    ...
                    if sync_point2 < sync_point1:
                        ...
                        while time() < stop_at and not retry_halted:
                            ...
                            retry_fetch_point = min(
                                partition_state['point']
                                for partition_state in
                                active_partitions.values())
                            ...
                            retry_rows_to_sync = [
                                ...
                                if row_partition in active_partitions and
                                row['ROWID'] >
                                active_partitions[row_partition]['point']]
                            retry_results = {
                                row['ROWID']: success
                            ...
                            for row, row_partition in rows_with_partitions:
                                ...
                                for partition, partition_state in \
                                        active_partitions.items():
                                    if partition in blocked_partitions or \
                                            rowid <= partition_state['point']:
                                        continue
